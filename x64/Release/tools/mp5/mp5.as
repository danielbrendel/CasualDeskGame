/*
	...
	Tool: MP5 Gun (developed by Daniel Brendel)
	Version: 0.2
...
void CDG_API_DrawOnTop()
{
	...
	R_DrawSprite(g_hXHair, Vector(g_vCursorPos[0] - 128 - 13, g_vCursorPos[1] + 10 - 12), 0, 0.0, Vector(-1, -1), 0.0, 0.0, false, Color(0, 0, 0, 0));
}
